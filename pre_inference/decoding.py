...
def exact_self_speculative_generate(model, tokenizer, input_ids, max_new_tokens=10, early_stop=False,
                 max_step_draft=12, th_stop_draft=0.8, auto_th_stop_draft=False, auto_parameters=[1,0.5,0.9,1e-2,0.9],
    ...
    return {
        ...
        'avg_draft_tokens': n_drafted/step_verify,
        'avg_matched_tokens': n_matched/step_verify,
